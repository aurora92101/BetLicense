...
import { Users, Settings, KeyRound, LaptopMinimalCheck, Presentation, Menu } from 'lucide-react';
...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { href: '/admin/license_manage', icon: KeyRound, label: 'License Key Manage' },
  ...
  return (
    <div className="flex flex-col min-h-[calc(100dvh-68px)] w-screen overflow-x-hidden">
      {/* Mobile header */}
